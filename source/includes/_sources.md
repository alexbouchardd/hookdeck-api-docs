...
Source objects allow you to accept webhooks from a third party.
...
This endpoint retrieves all sources.
...
| -------------- | --------- | -------------------------------------------- |
|  label         | string    | Name of the source                    |
|  alias         | string    | Alternate name for the source                 |
